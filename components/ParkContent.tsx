...
import { LocationData, SliderImage } from "@/components/Data";
import Collage from "@/components/Collages";
import Slider from "@/components/Slider";
import { ParkData } from "@/app/parks/actions";

interface ParkContentProps {
...
export default function ParkContent({
	...
	const images = [...initialImages, ...(parkData.images as SliderImage[])];
